...
/**
 * This class represents the node of the decision tree when a greater than (>)
 * operation is used
 */
public class DTNodeGreater extends DTNode {

	private static final long serialVersionUID = -6157603831332012728L;

	private double value;

	public DTNodeGreater(DTNode node) {
		super(node);
